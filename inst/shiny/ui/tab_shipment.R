tabPanel("Shipments",
         ...
         sidebarLayout(
           sidebarPanel(
             ...
             # uiOutput("selectUnit"),
             downloadButton(outputId="download_shipments_csv", "Download (.csv)", class="btn-secondary")
           ),
           ...
           mainPanel(
             ...
             div(class="container_trade",
                 ...
                 plotlyOutput("plot_shipments", width='100%', height='calc(100vh - 180px)') %>% withSpinner(color="#8cc9D0"),
                 div(class="row",
