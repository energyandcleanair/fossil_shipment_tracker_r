...
payments <- reactive({
  url <- sprintf("https://api.russiafossiltracker.com/v0/counter?date_from=2022-01-01&format=csv&aggregate_by=date,destination_region,commodity_group&rolling_days=7")
