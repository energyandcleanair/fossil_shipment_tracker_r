entsog_new.get_flows <- function(date_from='2021-11-01', use_cache=T){

  # Read files generated by Python scraper
  flows <- read_csv(sprintf("https://api.russiafossiltracker.com/v0/entsogflow?type=crossborder,production&format=csv&date_from=%s",date_from))
  # flows <- read_csv(sprintf("http://localhost:8080/v0/entsogflow?format=csv&date_from=%s",date_from))
