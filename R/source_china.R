...
china.get_flows_pipeline_oil <- function(use_google_sheets=T){
  ...
  if(use_google_sheets){
    ...
    path <- "https://docs.google.com/spreadsheets/d/e/2PACX-1vQunCwQmOpGXSLWiToq6zZDLi3VFqknU2fyDrRCtURFCT2QS1oer4H9i_eCXnyZfw/pub?gid=1904808077&single=true&output=csv"
    skip <- 0
  }else{
